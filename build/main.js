...
var start = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_D_JS_giveaway_node_modules_babel_runtime_regenerator___default.a.mark(function _callee5() {
    var _this = this;

    var r, app, host, port, config, nuxt, builder, routes;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 11:
            ...
            app.use(function () {
              var _ref8 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_D_JS_giveaway_node_modules_babel_runtime_regenerator___default.a.mark(function _callee4(ctx, next) {
                var path, route;
